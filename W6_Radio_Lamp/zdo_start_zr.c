...
void EXTI3_IRQHandler(void)
{
  if (EXTI_GetITStatus(EXTI_Line3) != RESET)
  {
    ...
    if (right_button_pressed) ZB_SCHEDULE_ALARM(Change_Color,0,ZB_MILLISECONDS_TO_BEACON_INTERVAL(100));
...
void EXTI2_IRQHandler(void)
{
  if (EXTI_GetITStatus(EXTI_Line2) != RESET)
  {
    ...
    ZB_SCHEDULE_ALARM_CANCEL(Toggle,0);
    ZB_SCHEDULE_ALARM_CANCEL(Change_Color,0);
    if (left_button_pressed) ZB_SCHEDULE_ALARM(Change_Color,0,ZB_MILLISECONDS_TO_BEACON_INTERVAL(100));
